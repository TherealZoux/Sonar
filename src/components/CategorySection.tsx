...
export default function CategorySection({ podcasts, title, loading }: Props) {
  ...
  return (
    <section className="flex flex-col max-w-[100%] h-[25rem] bg-white items-baseline shadow-[0px_7px_6px_0px_rgba(0,_0,_0,_0.1)] rounded-3xl gap-4 p-8 ">
      <h1 className="text-[26px] font-[700] text-[var(--color-sidebar-accent-foreground)]">{title}</h1>
      <div className="flex gap-4 overflow-hidden w-full h-full">
        {
          !loading ? (
